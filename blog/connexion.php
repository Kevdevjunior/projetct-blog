...
include 'inc/fonctions.inc.php'; // des fonctions utiles
    ...
    // Connexion utilisateur
     ...
     if( isset($_POST['pseudo']) && isset($_POST['mdp'])) {
        ...
        $connexion = $pdo->prepare("SELECT id_utilisateur, pseudo, mdp, statut, email, date_format(date_inscription, '%d/%m/%Y') AS date_inscription FROM utilisateur WHERE pseudo = :pseudo");
        ...
        if($connexion->rowCount() > 0) {
            ...
            if(password_verify($mdp, $infos['mdp'])) {
                ...
                /*
                c'est possible de faire de cette manière aussi
