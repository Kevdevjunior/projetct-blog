...
function get_categories() {
    global $pdo; // je rappele ou récupére la fonction $pdo grace a global (car ce nest pas une superglobal)
...
function create_post($titre, $img_principale, $id_categorie, $contenu) {
    ...
    // on récupère l'id_article qui vient d'être créé
...
// récupération des article pour affichage dans un tableau html
